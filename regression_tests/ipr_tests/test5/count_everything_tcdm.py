...
result_0_write_1 = count_matching_sw_lines(trace_lines_0, start_time, end_time, "1000e", val_prefix_0_write)
print(f"Matching writes: 0_write_1 {result_0_write_1}")


result_1_read_0 = count_matching_lw_lines(trace_lines_1, start_time, end_time, "1000e", val_prefix_0_write)
print(f"Matching loads: 1_read_0 {result_1_read_0}")


result_0_write_2 = count_matching_sw_lines(trace_lines_0, start_time, end_time, "1001", val_prefix_0_write)
print(f"Matching writes: result_0_write_2 {result_0_write_2}")


result_2_read_0 = count_matching_lw_lines(trace_lines_2, start_time, end_time, "1001", val_prefix_0_write)
...
result_1_write_0 = count_matching_sw_lines(trace_lines_1, start_time, end_time, "1000b", val_prefix_1_write)
print(f"Matching writes: 1_write_0 {result_1_write_0}")


result_0_read_1 = count_matching_lw_lines(trace_lines_0, start_time, end_time, "1000b", val_prefix_1_write)
print(f"Matching loads: 0_read_1 {result_0_read_1}")


result_1_write_3 = count_matching_sw_lines(trace_lines_1, start_time, end_time, "1001", val_prefix_1_write)
print(f"Matching writes: result_1_write_3 {result_1_write_3}")


result_3_read_1 = count_matching_lw_lines(trace_lines_3, start_time, end_time, "1001", val_prefix_1_write)
...
result_2_write_3 = count_matching_sw_lines(trace_lines_2, start_time, end_time, "1001", val_prefix_2_write)
print(f"Matching writes: 2_write_3 {result_2_write_3}")


result_3_read_2 = count_matching_lw_lines(trace_lines_3, start_time, end_time, "1001", val_prefix_2_write)
print(f"Matching loads: 3_read_2 {result_3_read_2}")


result_2_write_0 = count_matching_sw_lines(trace_lines_2, start_time, end_time, "1000", val_prefix_2_write)
print(f"Matching writes: result_2_write_0 {result_2_write_0}")


result_0_read_2 = count_matching_lw_lines(trace_lines_0, start_time, end_time, "1000", val_prefix_2_write)
...
result_3_write_2 = count_matching_sw_lines(trace_lines_3, start_time, end_time, "1001", val_prefix_3_write)
print(f"Matching writes: 3_write_2 {result_3_write_2}")


result_2_read_3 = count_matching_lw_lines(trace_lines_2, start_time, end_time, "1001", val_prefix_3_write)
print(f"Matching loads: 2_read_3 {result_2_read_3}")


result_3_write_1 = count_matching_sw_lines(trace_lines_3, start_time, end_time, "1000", val_prefix_3_write)
print(f"Matching writes: result_3_write_1 {result_3_write_1}")


result_1_read_3 = count_matching_lw_lines(trace_lines_1, start_time, end_time, "1000", val_prefix_3_write)
