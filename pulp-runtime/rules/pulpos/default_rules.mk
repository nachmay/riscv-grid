...
ifndef VSIM_PATH
	...
	ln -s $(VSIM_PATH)/hdl.var $@

$(TARGET_BUILD_DIR)/worklib:
ifndef VSIM_PATH
	$(error "VSIM_PATH is undefined. Either call \
	'source $$YOUR_HW_DIR/setup/vsim.sh' or set it manually.")
endif
	ln -s $(VSIM_PATH)/worklib $@
#---------------
...
ifdef gui
	@echo $(vsim_flags)
	cd $(TARGET_BUILD_DIR) && export VSIM_RUNNER_FLAGS='$(vsim_flags)'  && xmsim -gui $(XMSIM_FLAGS) worklib.tb_pulp; 
else
	@echo $(vsim_flags)
	cd $(TARGET_BUILD_DIR) && export VSIM_RUNNER_FLAGS='$(vsim_flags)'  && xmsim $(XMSIM_FLAGS) worklib.tb_pulp; 
endif
