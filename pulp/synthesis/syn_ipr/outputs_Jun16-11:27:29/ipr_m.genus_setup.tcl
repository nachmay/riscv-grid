...
phys::read_script outputs_Jun16-11:27:29/ipr_m.root.g
...
# Design
################################################################################
read_netlist -top ipr outputs_Jun16-11:27:29/ipr_m.v
read_metric -id current outputs_Jun16-11:27:29/ipr_m.metrics.json

phys::read_script outputs_Jun16-11:27:29/ipr_m.g

phys::read_lec_taf outputs_Jun16-11:27:29/ipr_m.lec.taf.gz
phys::read_taf outputs_Jun16-11:27:29/ipr_m.safety.taf.gz
...
if {$_slk_ != "-454.7"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden slack: -454.7,  current slack: $_slk_"
}
unset _slk_
# multi-mode slack
# tns
...
if {$_tns_ != "1930"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden tns: 1930,  current tns: $_tns_"
}
unset _tns_
# cell area
...
if {$_cell_area_ != "320"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden cell area: 320,  current cell area: $_cell_area_"
}
unset _cell_area_
# net area
