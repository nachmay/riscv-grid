...
set logfile logs_Jun18-13:21:45/intermediate2final.lec.log ;# user can modify this name for succeeding runs
...
set_verification_information ipr_cntrl_intermediatev_ipr_cntrl_mv_db

read_implementation_information fv/ipr_cntrl -golden ipr_cntrl_intermediatev -revised ipr_cntrl_mv
...
read_design -verilog95   -golden -lastmod -noelab outputs_Jun18-13:21:45/ipr_cntrl_intermediate.v
...
#add_name_alias fv/ipr_cntrl/ipr_cntrl_intermediatev.singlebit.original_name.alias.json.gz -golden
...
write_compared_points noneq.compared_points.ipr_cntrl.ipr_cntrl_intermediatev.ipr_cntrl_mv.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.ipr_cntrl.ipr_cntrl_intermediatev.ipr_cntrl_mv.rpt
}
report_test_vector -noneq > noneq.test_vector.ipr_cntrl.ipr_cntrl_intermediatev.ipr_cntrl_mv.rpt
