...
################################################################################
if {[::legacy::find -design /designs/ipr_cntrl] ne ""} {
  puts "** A design with the same name is already loaded. It will be removed. **"
  delete_obj /designs/ipr_cntrl
}
...
phys::read_script outputs_Jun18-13:21:45/ipr_cntrl_m.root.g
...
# Design
################################################################################
read_netlist -top ipr_cntrl outputs_Jun18-13:21:45/ipr_cntrl_m.v
read_metric -id current outputs_Jun18-13:21:45/ipr_cntrl_m.metrics.json

phys::read_script outputs_Jun18-13:21:45/ipr_cntrl_m.g

phys::read_lec_taf outputs_Jun18-13:21:45/ipr_cntrl_m.lec.taf.gz
phys::read_taf outputs_Jun18-13:21:45/ipr_cntrl_m.safety.taf.gz
...
# slack
set _slk_ [::legacy::get_attribute slack /designs/ipr_cntrl]
if {[regexp {^-?[0-9.]+$} $_slk_]} {
  set _slk_ [format %.1f $_slk_]
}
if {$_slk_ != "766.2"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden slack: 766.2,  current slack: $_slk_"
}
unset _slk_
# multi-mode slack
# tns
set _tns_ [::legacy::get_attribute tns /designs/ipr_cntrl]
if {[regexp {^-?[0-9.]+$} $_tns_]} {
...
unset _tns_
# cell area
set _cell_area_ [::legacy::get_attribute cell_area /designs/ipr_cntrl]
if {[regexp {^-?[0-9.]+$} $_cell_area_]} {
  set _cell_area_ [format %.0f $_cell_area_]
}
if {$_cell_area_ != "69"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden cell area: 69,  current cell area: $_cell_area_"
}
unset _cell_area_
# net area
set _net_area_ [::legacy::get_attribute net_area /designs/ipr_cntrl]
