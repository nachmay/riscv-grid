...
# Generated on: Wed Jun 18 13:22:11 UTC 2025 (Wed Jun 18 13:22:11 UTC 2025)
...
set logfile logs_Jun18-13:21:45/rtl2intermediate.lec.log ;# user can modify this name for succeeding runs
...
set_verification_information fv_map_ipr_cntrl_intermediatev_db

read_implementation_information fv/ipr_cntrl -golden fv_map -revised ipr_cntrl_intermediatev
...
read_design -verilog95   -golden -lastmod -noelab fv/ipr_cntrl/fv_map.v.gz
elaborate_design -golden -root {ipr_cntrl}

read_design -verilog95   -revised -lastmod -noelab outputs_Jun18-13:21:45/ipr_cntrl_intermediate.v
elaborate_design -revised -root {ipr_cntrl}

#add_name_alias fv/ipr_cntrl/fv_map.singlebit.original_name.alias.json.gz -golden
...
#add_name_alias fv/ipr_cntrl/ipr_cntrl_intermediatev.singlebit.original_name.alias.json.gz -revised
...
write_compared_points noneq.compared_points.ipr_cntrl.fv_map.ipr_cntrl_intermediatev.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.ipr_cntrl.fv_map.ipr_cntrl_intermediatev.rpt
}
report_test_vector -noneq > noneq.test_vector.ipr_cntrl.fv_map.ipr_cntrl_intermediatev.rpt
...
read_implementation_information fv/ipr_cntrl -revised fv_map
...
read_design -enumconstraint -define TARGET_GENUS -define TARGET_RTL -define TARGET_SYNTHESIS -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -sv09 /project/tsmc16/users/iday/ws/git/riscv-grid/pulp/rtl/ipr_dir/read_write_interface.sv
read_design -enumconstraint -define TARGET_GENUS -define TARGET_RTL -define TARGET_SYNTHESIS -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -sv09 /project/tsmc16/users/iday/ws/git/riscv-grid/pulp/rtl/ipr_dir/sv_ipr/rtl_syn/rptr_empty.sv /project/tsmc16/users/iday/ws/git/riscv-grid/pulp/rtl/ipr_dir/sv_ipr/rtl_syn/sync_r2w.sv /project/tsmc16/users/iday/ws/git/riscv-grid/pulp/rtl/ipr_dir/sv_ipr/rtl_syn/sync_w2r.sv /project/tsmc16/users/iday/ws/git/riscv-grid/pulp/rtl/ipr_dir/sv_ipr/rtl_syn/wptr_full.sv /project/tsmc16/users/iday/ws/git/riscv-grid/pulp/rtl/ipr_dir/sv_ipr/rtl_syn/async_fifo.sv /project/tsmc16/users/iday/ws/git/riscv-grid/pulp/rtl/ipr_dir/sv_ipr/rtl_syn/ipr_cntrl.sv
elaborate_design -golden -root {ipr_cntrl} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/ipr_cntrl/fv_map.v.gz
elaborate_design -revised -root {ipr_cntrl}
...
#add_name_alias fv/ipr_cntrl/fv_map.singlebit.original_name.alias.json.gz -revised
#set_mapping_method -alias -revised
#add_renaming_rule r1alias _reg((\\\[%w\\\])*(/U\\\$%d)*)$ @1 -type dff dlat -both
...
write_compared_points noneq.compared_points.ipr_cntrl.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.ipr_cntrl.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.ipr_cntrl.rtl.fv_map.rpt
write_verification_information
report_verification_information
