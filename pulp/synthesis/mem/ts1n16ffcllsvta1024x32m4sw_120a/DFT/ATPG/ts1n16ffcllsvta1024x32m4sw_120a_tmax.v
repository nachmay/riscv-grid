...
module TS1N16FFCLLSVTA1024X32M4SW (
  CLK,
  CEB,
  WEB,
  A,
...
//---- RAM Enable
TS1N16FFCLLSVTA1024X32M4SW_RAM_Enable_handle u_RAM_Enable_handle (
...
//---- RAM Core
TS1N16FFCLLSVTA1024X32M4SW_RAM_Core u_RAM_Core (
  //---- clock
  .RAM_CLK      ( ram_clk),
  //---- RAM IO
  .RAM_D        ( i_D),
...
module TS1N16FFCLLSVTA1024X32M4SW_RAM_D_handle ( MEM, D, BWEB, Z );
...
module TS1N16FFCLLSVTA1024X32M4SW_RAM_Enable_handle (
  MODE_SRAM_OP,
  RAM_WEB,
  RAM_CEB,
  RAM_WRITE,
...
module TS1N16FFCLLSVTA1024X32M4SW_RAM_Core (
  //---- clock
  RAM_CLK,
  //---- RAM IO
  RAM_D,
...
//-------- Combinational Network --------//
//---- input data handling
TS1N16FFCLLSVTA1024X32M4SW_RAM_D_handle u_RDH0 (.MEM(data_mem), .D(RAM_D), .BWEB(RAM_BWEB), .Z(data_in));
