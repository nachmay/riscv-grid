...
`ifdef TSMC_INITIALIZE_MEM
  parameter cdeFileInit  = "TS6N16FFCLLSVTA8X32M1FW_initial.cde";
`endif
`ifdef TSMC_INITIALIZE_FAULT
   parameter cdeFileFault = "TS6N16FFCLLSVTA8X32M1FW_fault.cde";
`endif
...
TS6N16FFCLLSVTA8X32M1FW_Int_Array #(1,1,W,N,M,MES_ALL) MX (.D({DL}),.BW({BWEBL}),
...
*/
module TS6N16FFCLLSVTA8X32M1FW_Int_Array (D, BW, AW, EN, RDB, AR, Q);
