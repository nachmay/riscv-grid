...
`ifdef TSMC_INITIALIZE_MEM
parameter cdeFileInit  = "TS5N16FFCLLSVTA8X128M1SW_initial.cde";
`endif
`ifdef TSMC_INITIALIZE_FAULT
parameter cdeFileFault = "TS5N16FFCLLSVTA8X128M1SW_fault.cde";
`endif
