...
module TS6N16FFCLLSVTA32X32M4FW (
  CLKW,
  CLKR,
  WEB,
  REB,
...
//---- RAM Enable
TS6N16FFCLLSVTA32X32M4FW_RAM_Enable_handle u_RAM_Enable_handle (
...
//---- RAM Core
TS6N16FFCLLSVTA32X32M4FW_RAM_Core u_RAM_Core (
  //---- clock
  .RAM_CLKW      ( ram_clk_w),
  .RAM_CLKR      ( ram_clk_r),
  //---- RAM IO
...
module TS6N16FFCLLSVTA32X32M4FW_RAM_D_handle ( MEM, D, BWEB, Z );
...
module TS6N16FFCLLSVTA32X32M4FW_RAM_Enable_handle (
  MODE_SRAM_OP,
  RAM_WEB,
  RAM_REB,
  RAM_WRITE,
...
module TS6N16FFCLLSVTA32X32M4FW_RAM_Core (
  //---- clock
  RAM_CLKW,
  RAM_CLKR,
  //---- RAM IO
...
//-------- Combinational Network --------//
//---- input data handling
TS6N16FFCLLSVTA32X32M4FW_RAM_D_handle u_RDH0 (.MEM(data_mem), .D(RAM_D), .BWEB(RAM_BWEB), .Z(data_in));
...
nor u_eqA (AeqB, AcomB[0], AcomB[1], AcomB[2], AcomB[3], AcomB[4]);
