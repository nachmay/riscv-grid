...
buf ub_AA3 (b_AA[3], AA[3]);
buf ub_AA4 (b_AA[4], AA[4]);
buf ub_AA5 (b_AA[5], AA[5]);
buf ub_AB0 (b_AB[0], AB[0]);
buf ub_AB1 (b_AB[1], AB[1]);
buf ub_AB2 (b_AB[2], AB[2]);
buf ub_AB3 (b_AB[3], AB[3]);
buf ub_AB4 (b_AB[4], AB[4]);
buf ub_AB5 (b_AB[5], AB[5]);
buf ub_D0 (b_D[0], D[0]);
buf ub_D1 (b_D[1], D[1]);
buf ub_D2 (b_D[2], D[2]);
buf ub_D3 (b_D[3], D[3]);
...
buf ub_iAA3 (i_AA[3], b_AA[3]);
buf ub_iAB3 (i_AB[3], b_AB[3]);
buf ub_iAA4 (i_AA[4], b_AA[4]);
buf ub_iAB4 (i_AB[4], b_AB[4]);
buf ub_iAA5 (i_AA[5], b_AA[5]);
buf ub_iAB5 (i_AB[5], b_AB[5]);
...
//---- RAM Enable
TS6N16FFCLLSVTA64X32M4FW_RAM_Enable_handle u_RAM_Enable_handle (
...
//---- RAM Core
TS6N16FFCLLSVTA64X32M4FW_RAM_Core u_RAM_Core (
  //---- clock
  .RAM_CLKW      ( ram_clk_w),
  .RAM_CLKR      ( ram_clk_r),
  //---- RAM IO
...
module TS6N16FFCLLSVTA64X32M4FW_RAM_D_handle ( MEM, D, BWEB, Z );
...
module TS6N16FFCLLSVTA64X32M4FW_RAM_Enable_handle (
  MODE_SRAM_OP,
  RAM_WEB,
  RAM_REB,
  RAM_WRITE,
...
module TS6N16FFCLLSVTA64X32M4FW_RAM_Core (
  //---- clock
  RAM_CLKW,
  RAM_CLKR,
  //---- RAM IO
...
//-------- Combinational Network --------//
//---- input data handling
TS6N16FFCLLSVTA64X32M4FW_RAM_D_handle u_RDH0 (.MEM(data_mem), .D(RAM_D), .BWEB(RAM_BWEB), .Z(data_in));
...
xor u_comAddr3 (AcomB[3], RAM_AA[3], RAM_AB[3]);
xor u_comAddr4 (AcomB[4], RAM_AA[4], RAM_AB[4]);
xor u_comAddr5 (AcomB[5], RAM_AA[5], RAM_AB[5]);
//---- check sram_contention
nor u_eqA (AeqB, AcomB[0], AcomB[1], AcomB[2], AcomB[3], AcomB[4], AcomB[5]);
...
_MUX m_x_AA3 (sram_contention, RAM_AB[3], 1'bx, i_RAM_AB[3]);
_MUX m_x_AA4 (sram_contention, RAM_AB[4], 1'bx, i_RAM_AB[4]);
_MUX m_x_AA5 (sram_contention, RAM_AB[5], 1'bx, i_RAM_AB[5]);
