...
#  Created by Genus(TM) Synthesis Solution 22.16-s078_1 on Wed Jun 18 13:22:19 UTC 2025
...
group_path -name C2C -from [list \
  ...
  [get_cells {async_fifo_i_sync_r2w_inst_wq2_rptr_reg[0]}] ] -to [list \
  [get_cells async_fifo_i_wptr_full_inst/RC_CG_HIER_INST0/RC_CGIC_INST]  \
  [get_cells {async_fifo_i_rptr_empty_inst/rptr_reg[0]}]  \
  [get_cells {async_fifo_i_rptr_empty_inst/rptr_reg[3]}]  \
  [get_cells {async_fifo_i_rptr_empty_inst/rptr_reg[1]}]  \
  [get_cells {async_fifo_i_rptr_empty_inst/rptr_reg[2]}]  \
...
group_path -name cg_enable_group_clk -through [list \
  [get_pins async_fifo_i_wptr_full_inst/RC_CG_HIER_INST0/enable]  \
  [get_pins async_fifo_i_wptr_full_inst/RC_CG_HIER_INST0/RC_CGIC_INST/E]  \
  [get_pins async_fifo_i_wptr_full_inst/RC_CG_HIER_INST0/enable]  \
  [get_pins async_fifo_i_wptr_full_inst/RC_CG_HIER_INST0/RC_CGIC_INST/E]  \
  [get_pins async_fifo_i_wptr_full_inst/RC_CG_HIER_INST0/enable]  \
  [get_pins async_fifo_i_wptr_full_inst/RC_CG_HIER_INST0/RC_CGIC_INST/E] ]
...
set_input_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {rdata[7]}]
set_input_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {rdata[6]}]
set_input_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {rdata[5]}]
set_input_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {rdata[4]}]
set_input_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {rdata[3]}]
set_input_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {rdata[2]}]
set_input_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {rdata[1]}]
set_input_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {rdata[0]}]
...
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports we]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports re]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {wdata[7]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {wdata[6]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {wdata[5]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {wdata[4]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {wdata[3]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {wdata[2]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {wdata[1]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {wdata[0]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {waddr[3]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {waddr[2]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {waddr[1]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {waddr[0]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {raddr[3]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {raddr[2]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {raddr[1]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {raddr[0]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports fifo_full]
