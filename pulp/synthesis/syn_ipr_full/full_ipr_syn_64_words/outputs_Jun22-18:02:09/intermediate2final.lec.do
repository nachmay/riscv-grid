...
set logfile logs_Jun22-18:02:09/intermediate2final.lec.log ;# user can modify this name for succeeding runs
...
set_verification_information ipr_intermediatev_ipr_mv_db

read_implementation_information fv/ipr -golden ipr_intermediatev -revised ipr_mv
...
read_design -verilog95   -golden -lastmod -noelab outputs_Jun22-18:02:09/ipr_intermediate.v
...
#add_name_alias fv/ipr/ipr_intermediatev.singlebit.original_name.alias.json.gz -golden
...
write_compared_points noneq.compared_points.ipr.ipr_intermediatev.ipr_mv.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.ipr.ipr_intermediatev.ipr_mv.rpt
}
report_test_vector -noneq > noneq.test_vector.ipr.ipr_intermediatev.ipr_mv.rpt
