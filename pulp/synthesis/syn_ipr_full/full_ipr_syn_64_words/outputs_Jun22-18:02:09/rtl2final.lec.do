...
# Generated on: Sun Jun 22 18:02:52 UTC 2025 (Sun Jun 22 18:02:52 UTC 2025)
...
set logfile logs_Jun22-18:02:09/rtl2final.lec.log ;# user can modify this name for succeeding runs
...
set_verification_information fv_map_ipr_mv_db

read_implementation_information fv/ipr -golden fv_map -revised ipr_mv
...
read_design -verilog95   -revised -lastmod -noelab outputs_Jun22-18:02:09/ipr_m.v
...
#add_name_alias fv/ipr/ipr_mv.singlebit.original_name.alias.json.gz -revised
...
write_compared_points noneq.compared_points.ipr.fv_map.ipr_mv.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.ipr.fv_map.ipr_mv.rpt
}
report_test_vector -noneq > noneq.test_vector.ipr.fv_map.ipr_mv.rpt
