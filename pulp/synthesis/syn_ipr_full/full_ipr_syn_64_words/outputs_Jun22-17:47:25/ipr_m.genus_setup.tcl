...
phys::read_script outputs_Jun22-17:47:25/ipr_m.root.g
...
# Design
################################################################################
read_netlist -top ipr outputs_Jun22-17:47:25/ipr_m.v
read_metric -id current outputs_Jun22-17:47:25/ipr_m.metrics.json

phys::read_script outputs_Jun22-17:47:25/ipr_m.g

phys::read_lec_taf outputs_Jun22-17:47:25/ipr_m.lec.taf.gz
phys::read_taf outputs_Jun22-17:47:25/ipr_m.safety.taf.gz
...
if {$_slk_ != "717.7"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden slack: 717.7,  current slack: $_slk_"
}
unset _slk_
# multi-mode slack
# tns
...
if {$_net_area_ != "119"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden net area: 119,  current net area: $_net_area_"
}
unset _net_area_
