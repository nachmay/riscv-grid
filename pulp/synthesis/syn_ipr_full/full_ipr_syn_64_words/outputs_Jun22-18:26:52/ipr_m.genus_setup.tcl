...
phys::read_script outputs_Jun22-18:26:52/ipr_m.root.g
...
# Design
################################################################################
read_netlist -top ipr outputs_Jun22-18:26:52/ipr_m.v
read_metric -id current outputs_Jun22-18:26:52/ipr_m.metrics.json

phys::read_script outputs_Jun22-18:26:52/ipr_m.g

phys::read_lec_taf outputs_Jun22-18:26:52/ipr_m.lec.taf.gz
phys::read_taf outputs_Jun22-18:26:52/ipr_m.safety.taf.gz
...
if {$_slk_ != "844.4"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden slack: 844.4,  current slack: $_slk_"
}
unset _slk_
# multi-mode slack
# tns
...
if {$_cell_area_ != "144"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden cell area: 144,  current cell area: $_cell_area_"
}
unset _cell_area_
# net area
...
if {$_net_area_ != "38"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden net area: 38,  current net area: $_net_area_"
}
unset _net_area_
