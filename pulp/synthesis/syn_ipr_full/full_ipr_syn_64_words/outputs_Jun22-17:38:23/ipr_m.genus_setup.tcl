...
################################################################################
if {[::legacy::find -design /designs/ipr] ne ""} {
  puts "** A design with the same name is already loaded. It will be removed. **"
  delete_obj /designs/ipr
}
...
phys::read_script outputs_Jun22-17:38:23/ipr_m.root.g
...
# Design
################################################################################
read_netlist -top ipr outputs_Jun22-17:38:23/ipr_m.v
read_metric -id current outputs_Jun22-17:38:23/ipr_m.metrics.json

phys::read_script outputs_Jun22-17:38:23/ipr_m.g

phys::read_lec_taf outputs_Jun22-17:38:23/ipr_m.lec.taf.gz
phys::read_taf outputs_Jun22-17:38:23/ipr_m.safety.taf.gz
...
# slack
set _slk_ [::legacy::get_attribute slack /designs/ipr]
if {[regexp {^-?[0-9.]+$} $_slk_]} {
  set _slk_ [format %.1f $_slk_]
}
if {$_slk_ != "731.3"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden slack: 731.3,  current slack: $_slk_"
}
unset _slk_
# multi-mode slack
# tns
set _tns_ [::legacy::get_attribute tns /designs/ipr]
if {[regexp {^-?[0-9.]+$} $_tns_]} {
...
unset _tns_
# cell area
set _cell_area_ [::legacy::get_attribute cell_area /designs/ipr]
if {[regexp {^-?[0-9.]+$} $_cell_area_]} {
  set _cell_area_ [format %.0f $_cell_area_]
}
if {$_cell_area_ != "778"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden cell area: 778,  current cell area: $_cell_area_"
}
unset _cell_area_
# net area
set _net_area_ [::legacy::get_attribute net_area /designs/ipr]
if {[regexp {^-?[0-9.]+$} $_net_area_]} {
  set _net_area_ [format %.0f $_net_area_]
}
if {$_net_area_ != "221"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden net area: 221,  current net area: $_net_area_"
}
unset _net_area_
