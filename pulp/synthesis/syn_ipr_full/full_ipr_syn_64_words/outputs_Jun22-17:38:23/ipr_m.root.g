...
# Created by Genus(TM) Synthesis Solution 22.16-s078_1 on Sun Jun 22 17:39:23 UTC 2025
...
::legacy::set_attribute -quiet runtime_by_stage {{PBS_Generic-Start 0 39 0.0 35.977183} {to_generic 2 42 2 39} {first_condense 3 46 4 44} {PBS_Generic_Opt-Post 8 47 7.732946000000005 43.710129} {{PBS_Generic-Postgen HBO Optimizations} 0 47 0.0 43.710129} {PBS_TechMap-Start 0 48 0.0 44.710129} {{PBS_TechMap-Premap HBO Optimizations} 0 48 0.0 44.710129} {first_condense 4 52 5 52} {reify 6 58 9 61} {global_incr_map 2 60 1 63} {{PBS_Techmap-Global Mapping} 12 60 12.265329999999999 56.975459} {{PBS_TechMap-Datapath Postmap Operations} 3 63 3.0 59.975459} {{PBS_TechMap-Postmap HBO Optimizations} 0 63 -0.009563999999997463 59.965895} {{PBS_TechMap-Postmap Clock Gating} 0 63 0.0 59.965895} {{PBS_TechMap-Postmap Cleanup} 0 63 -0.007630000000006021 59.958265} {PBS_Techmap-Post_MBCI 0 63 0.0 59.958265} {incr_opt 0 70 0 71} } /
...
## Written on 17:39:23 22-Jun 2025
#############################################################
#####   Flow Definitions   ##################################
