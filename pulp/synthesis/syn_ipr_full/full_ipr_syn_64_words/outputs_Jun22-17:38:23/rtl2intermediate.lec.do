...
# Generated on: Sun Jun 22 17:39:10 UTC 2025 (Sun Jun 22 17:39:10 UTC 2025)
...
set logfile logs_Jun22-17:38:23/rtl2intermediate.lec.log ;# user can modify this name for succeeding runs
...
set_verification_information fv_map_ipr_intermediatev_db

read_implementation_information fv/ipr -golden fv_map -revised ipr_intermediatev
...
read_design -verilog95   -golden -lastmod -noelab fv/ipr/fv_map.v.gz
elaborate_design -golden -root {ipr}

read_design -verilog95   -revised -lastmod -noelab outputs_Jun22-17:38:23/ipr_intermediate.v
elaborate_design -revised -root {ipr}

#add_name_alias fv/ipr/fv_map.singlebit.original_name.alias.json.gz -golden
...
#add_name_alias fv/ipr/ipr_intermediatev.singlebit.original_name.alias.json.gz -revised
...
write_compared_points noneq.compared_points.ipr.fv_map.ipr_intermediatev.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.ipr.fv_map.ipr_intermediatev.rpt
}
report_test_vector -noneq > noneq.test_vector.ipr.fv_map.ipr_intermediatev.rpt
...
read_implementation_information fv/ipr -revised fv_map
...
read_design -enumconstraint -define TARGET_GENUS -define TARGET_RTL -define TARGET_SYNTHESIS -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -sv09 /project/tsmc16/users/iday/ws/git/riscv-grid/pulp/rtl/ipr_dir/sv_ipr/rtl/rptr_empty.sv /project/tsmc16/users/iday/ws/git/riscv-grid/pulp/rtl/ipr_dir/sv_ipr/rtl/sync_r2w.sv /project/tsmc16/users/iday/ws/git/riscv-grid/pulp/rtl/ipr_dir/sv_ipr/rtl/sync_w2r.sv /project/tsmc16/users/iday/ws/git/riscv-grid/pulp/rtl/ipr_dir/sv_ipr/rtl/wptr_full.sv /project/tsmc16/users/iday/ws/git/riscv-grid/pulp/rtl/ipr_dir/sv_ipr/rtl/fifomem.sv /project/tsmc16/users/iday/ws/git/riscv-grid/pulp/rtl/ipr_dir/sv_ipr/rtl/async_fifo.sv /project/tsmc16/users/iday/ws/git/riscv-grid/pulp/rtl/ipr_dir/sv_ipr/rtl/ipr.sv
elaborate_design -golden -root {ipr} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/ipr/fv_map.v.gz
elaborate_design -revised -root {ipr}
...
#add_name_alias fv/ipr/fv_map.singlebit.original_name.alias.json.gz -revised
#set_mapping_method -alias -revised
#add_renaming_rule r1alias _reg((\\\[%w\\\])*(/U\\\$%d)*)$ @1 -type dff dlat -both
...
set_system_mode lec
write_compared_points noneq.compared_points.ipr.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.ipr.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.ipr.rtl.fv_map.rpt
