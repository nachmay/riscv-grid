...
# Generated on: Mon Jun 23 11:20:16 UTC 2025 (Mon Jun 23 11:20:16 UTC 2025)
...
set logfile logs_Jun23-10:31:50/intermediate2final.lec.log ;# user can modify this name for succeeding runs
...
set_verification_information udma_subsystem_intermediatev_udma_subsystem_mv_db

read_implementation_information fv/udma_subsystem -golden udma_subsystem_intermediatev -revised udma_subsystem_mv
...
read_design -verilog95   -golden -lastmod -noelab outputs_Jun23-10:31:50/udma_subsystem_intermediate.v
...
#add_name_alias fv/udma_subsystem/udma_subsystem_intermediatev.singlebit.original_name.alias.json.gz -golden
...
write_compared_points noneq.compared_points.udma_subsystem.udma_subsystem_intermediatev.udma_subsystem_mv.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.udma_subsystem.udma_subsystem_intermediatev.udma_subsystem_mv.rpt
}
report_test_vector -noneq > noneq.test_vector.udma_subsystem.udma_subsystem_intermediatev.udma_subsystem_mv.rpt
