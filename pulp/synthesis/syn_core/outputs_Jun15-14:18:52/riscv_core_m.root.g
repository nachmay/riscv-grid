...
# Created by Genus(TM) Synthesis Solution 22.16-s078_1 on Sun Jun 15 14:32:47 UTC 2025
...
::legacy::set_attribute -quiet runtime_by_stage {{PBS_Generic-Start 0 55 0.0 0.0} {to_generic 162 219 0 0} {first_condense 126 408 0 0} {PBS_Generic_Opt-Post 358 414 0.0 0.0} {{PBS_Generic-Postgen HBO Optimizations} 1 415 0.0 0.0} {PBS_TechMap-Start 0 423 0.0 0.0} {{PBS_TechMap-Premap HBO Optimizations} 1 424 0.0 0.0} {first_condense 103 533 0 0} {reify 181 714 0 0} {global_incr_map 27 741 0 0} {{PBS_Techmap-Global Mapping} 319 743 0.0 0.0} {{PBS_TechMap-Datapath Postmap Operations} 6 749 0.0 0.0} {{PBS_TechMap-Postmap HBO Optimizations} 1 750 0.0 0.0} {{PBS_TechMap-Postmap Clock Gating} 3 753 0.0 0.0} {{PBS_TechMap-Postmap Cleanup} 4 757 0.0 0.0} {PBS_Techmap-Post_MBCI 0 757 0.0 0.0} {incr_opt 34 805 0 0} } /
...
## Written on 14:32:47 15-Jun 2025
#############################################################
#####   Flow Definitions   ##################################
