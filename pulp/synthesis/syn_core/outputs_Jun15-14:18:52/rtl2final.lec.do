...
set logfile logs_Jun15-14:18:52/rtl2final.lec.log ;# user can modify this name for succeeding runs
...
set_verification_information fv_map_riscv_core_mv_db

read_implementation_information fv/riscv_core -golden fv_map -revised riscv_core_mv
...
write_compared_points noneq.compared_points.riscv_core.fv_map.riscv_core_mv.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.riscv_core.fv_map.riscv_core_mv.rpt
}
report_test_vector -noneq > noneq.test_vector.riscv_core.fv_map.riscv_core_mv.rpt
