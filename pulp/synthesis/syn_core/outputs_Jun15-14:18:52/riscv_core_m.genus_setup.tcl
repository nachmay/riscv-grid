...
phys::read_script outputs_Jun15-14:18:52/riscv_core_m.root.g
...
# Design
################################################################################
read_netlist -top riscv_core outputs_Jun15-14:18:52/riscv_core_m.v
read_metric -id current outputs_Jun15-14:18:52/riscv_core_m.metrics.json

phys::read_script outputs_Jun15-14:18:52/riscv_core_m.g

phys::read_lec_taf outputs_Jun15-14:18:52/riscv_core_m.lec.taf.gz
phys::read_taf outputs_Jun15-14:18:52/riscv_core_m.safety.taf.gz
...
if {$_slk_ != "-573.3"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden slack: -573.3,  current slack: $_slk_"
}
unset _slk_
# multi-mode slack
# tns
...
if {$_tns_ != "19384"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden tns: 19384,  current tns: $_tns_"
}
unset _tns_
# cell area
...
if {$_cell_area_ != "8384"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden cell area: 8384,  current cell area: $_cell_area_"
}
unset _cell_area_
# net area
...
if {$_net_area_ != "4209"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden net area: 4209,  current net area: $_net_area_"
}
unset _net_area_
